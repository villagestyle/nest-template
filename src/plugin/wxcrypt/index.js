...
var WXBizMsgCrypt = /** @class */ (function () {
    ...
    WXBizMsgCrypt.prototype.decrypt = function (msgSignature, timestamp, nonce, msgEncrypt) {
        ...
        // AES解密
        var decipher = util_1.tryThrow(-40004, 'AESKey 非法', function () { 
            return crypto_1.createDecipheriv('aes-256-cbc', _this.aesKey, _this.iv).setAutoPadding(false); 
        });
        var buffer = util_1.tryThrow(-40007, 'AES 解密失败', function () { 
    ...
    WXBizMsgCrypt.prototype.decryptMsg = function (msgSignature, timestamp, nonce, postData) {
        return this.decrypt(msgSignature, timestamp, nonce, 
            util_1.tryThrow(-40002, 'xml解析失败', 
            function () { 
                return util_1.x2o(postData).Encrypt; 
            })
        );
    };
    /**
